...
pub async fn run_init(args: InitArgs) -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!(" ✓ ({} tables, {} views)", table_count, view_count);
...
"#,
    ...
    if let Some(ref lang) = args.lang {
        ...
        println!("Generated {} → {}", lang, output_file);
    }
    ...
    println!();
    println!("  💡 Set your password via: export LAZYPAW_PASSWORD='...'");
